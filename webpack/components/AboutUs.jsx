	...
	<div>
		...
		<div className="dream-team">
		  <div className="section wrapper">
		    <div className="row">
		      <h3 className="center">The Dream Team</h3>
		      <div className="col s12 m6 center">
		        <img src="http://res.cloudinary.com/jsfowles/image/upload/v1468039859/About/IMG_8305.jpg" className='profile-picture responsive-image' alt="Taylor" />
		        <h4>Taylor Wu</h4>
		    ...
		    <div className="row">
		      <div className="col s12 m6 center">
		        <img src="http://res.cloudinary.com/jsfowles/image/upload/v1468039859/About/IMG_8309.jpg" className='profile-picture responsive-image' alt="Mara" />
		      ...
		      <div className="col s12 m6 center">
		        <img src="http://res.cloudinary.com/jsfowles/image/upload/v1468039863/About/IMG_8296.jpg" className='profile-picture responsive-image' alt="Faith" />
      ...
      <div className="parallax img-holder">
      	<img src="http://res.cloudinary.com/jsfowles/image/upload/c_scale,w_1100/v1467843368/IMG_8246_s0fgmh.jpg" alt='DevPoint Labs' />
      	<a href="http://www.devpointlabs.com" className="link waves-effect waves-light btn grey" target="_blank">Learn More</a>
      </div>
		</div>
		<div className="container">
